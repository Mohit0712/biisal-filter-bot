...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001907242220'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/+4RB2-U2o9yE4ZmQ9')
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001752365376').split()]
...
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1001907242220'))
...
BIN_CHANNEL = int(environ.get('BIN_CHANNEL','-1001907242220'))
DELETE_CHANNELS = int(environ.get('DELETE_CHANNELS','-1001907242220'))
URL = environ.get('URL', 'mytestbot-jvdfhbj.com')
STICKERS_IDS = ('CAACAgQAAxkBAAEK99dlfC7LDqnuwtGRkIoacot_dGC4zQACbg8AAuHqsVDaMQeY6CcRojME').split()
FILE_AUTO_DEL_TIMER = int(environ.get('FILE_AUTO_DEL_TIMER', '600'))
IS_VERIFY = is_enabled('IS_VERIFY', False)
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1001907242220'))
